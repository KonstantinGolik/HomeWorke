...
При слиянии веток может произойти конфлик, когда в разных ветках одни и теже строчки содержат разные данные. Git не поймёт, какую версию необходимо использовать.