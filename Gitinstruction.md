...
В первую очередь нужно создать аккаунт на сервисе с которым будете работать удаленно. В нашем случае это **GitHub**. Соответственно авторизироваться и начать работу.
